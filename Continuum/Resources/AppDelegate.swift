...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  var window: UIWindow?
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool { checkAccountStatus { (sucess) in let fetchedUserStatement = sucess ? "Successfully retrieved a logged in user" : "Failed to retrieve a logged in user"
